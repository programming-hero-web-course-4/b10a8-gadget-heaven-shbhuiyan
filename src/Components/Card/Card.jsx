...
const Card = ({ product }) => {
  ...
  return (
    <div className="border-2 p-4 rounded-xl flex flex-col justify-between gap-6 shadow-lg">
      ...
      <Link className="px-6 py-2 text-xl font-semibold border-2 border-purple-600 rounded-full text-center hover:bg-purple-600 hover:text-white duration-500 hover:scale-105">
        View Details
      </Link>
    </div>
  );
